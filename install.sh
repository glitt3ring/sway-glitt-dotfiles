...
sudo pacman -Syu --needed --noconfirm sway swayidle swaylock wofi waybar bluez bluez-utils blueman xdg-desktop-portal xdg-desktop-portal-wlr alacritty pipewire pipewire-alsa pipewire-audio pipewire-docs pipewire-ffado pipewire-jack pipewire-libcamera pipewire-roc wireplumber pipewire-v4l2 pipewire-x11-bell pipewire-zeroconf realtime-privileges rtkit pipewire-pulse pavucontrol power-profiles-daemon lightdm lightdm-gtk-greeter lightdm-gtk-greeter-settings nerd-fonts ttf-font-awesome xorg wayland xorg-xwayland
