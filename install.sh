...
sudo pacman -Syu --needed --noconfirm sway swayidle swaylock wofi waybar xfce4-screenshooter bluez bluez-utils blueman xdg-desktop-portal xdg-desktop-portal-wlr alacritty pipewire pipewire-alsa pipewire-audio pipewire-docs pipewire-ffado pipewire-jack pipewire-libcamera pipewire-roc pipewire-session-manager pipewire-v4l2 pipewire-x11-bell pipewire-zerconf realtime-privileges pipewire-pulse pavucontrol power-profiles-daemon lightdm lightdm-gtk-greeter lightdm-gtk-greeter-settings nerd-fonts ttf-font-awesome xorg wayland xorg-xwayland
